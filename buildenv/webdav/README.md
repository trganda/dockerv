...
* [`2.0`, `latest`](https://github.com/trganda/dockerv/buildenv/webdav/Dockerfile)

## Quick reference

> This repo was copy from https://github.com/BytemarkHosting/docker-webdav and fix some issues.
...
* **Code repository:**
  https://github.com/trganda/dockerv/buildenv/webdav
...
docker run --restart always -v /srv/dav:/var/lib/dav \
    ...
    -e SSL_CERT=selfsigned --publish 443:443 -d jongsx/webdav
